...
- v vsaki lokaciji izračunamo svojo normalo
...
- spet imamo zapis na podlagi utežene vsota, (bi)polinomski zapis s koeficienti in matrični zapis
- matrika geometrija postane 4x4

Bikubična bezierjeva krpa:
- rabimo 16 točk (4^2)
- 4 točka na robu, vse ostale točka samo vplivajo na krivuljo
