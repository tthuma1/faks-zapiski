...
- procesni stanj niti v Windows:
	- ![500](Pasted%20image%2020240325141727.png)
	...
	- ni nujno da zbrišemo strukturo enega procesa, ker bi najbrž podobna za nek drug proces - reinicializira (ponovno uporabi) to isto strukturo

Tradicionalni Unix struktura procesa:
- ![500](Pasted%20image%2020240325142437.png)
- User IDs, ker je več uporabnikov
- tabela signalov, komu naj jedro pošlje signal naprej
- file deskriptors - katere datotečne vire imam v uporabi
- procesna slika (memory map)
- stanje procesorja - ves kontekst (PCB + še stvari zraven), tu imamo tudi jedrni sklad
- tradicionalni Unix nima več nitinega okolja, lahko imamo še vedno več niti znotraj procesa (ULT)
- več niti je pri Solaris (moderni Unix):
	- peresni procesi (lightweight proces, LWP) = niti
	- imamo kazalci na LWP-je
	...
	- ![500](Pasted%20image%2020240325142740.png)
- model stanja niti v Solaris (na ULT in KLT nivoju):
	- ![500](Pasted%20image%2020240325142857.png)
	- run = ready
	- onproc = running
	- sleep = blocked
...
- ![500](Pasted%20image%2020240325143837.png)
