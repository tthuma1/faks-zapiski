...
- osnovne funkcionalnosti (predajanje sporočil (message passing)):
	...
	3. komuniciranje s/dostop do strojne opreme
...
- plastni OS (layered kernel):
	- smiselno, vendar interakcija je možna samo med posameznimi nivoji (če hoče file system z I/O rabi vmes še čez eno)
...
- mikrojedro:
	...
	- zgoraj imamo v nepriviligiranem načinu vse ostale storitve OS (driverji, virutal memory manager ...)
