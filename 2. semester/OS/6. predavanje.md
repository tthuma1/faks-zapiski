...
- zaznavanje smrtnih objemov (deadlock detection):
	...
	- ko se proces odvija, preverjaš za prisotnost smrtnega objema - če je smrtni objem, narediš korak nazaj (state rollback) in po drugi poti naprej; če še vedno ne gre, narediš še en korak nazaj
