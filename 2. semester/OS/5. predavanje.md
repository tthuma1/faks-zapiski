...
- podpora v OS-u:
	- mehanizmi, ki jih OS implementira za sočasnost:
		1. semaforji
		2. monitoring
...
- tisti, ki proces, ki je dal `wait`, da tudi `signal` - je mutex
...
- česa koncept semaforja nima: vrtenja v prazno (to je problem storjnih ukazov); ima pa vrsto, posebno spremenljivko, funkciji wait in signal in 