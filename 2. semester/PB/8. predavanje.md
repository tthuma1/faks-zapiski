...
Arhitektura ODBC:
- ODB upravljalec gonilnikov je del infrastrukture, ki ugotovi, kako se povežemo, naloži ustrezen gonilnik (dinamično nalaganje gonilnikov) in posreduje poizvedbe podatkovni bazi
- ODBC gonilnik je drugačen za vsak SUPB - ustrezno preoblikuje podatke; omogoča manjkajočo funkcionalnost glede na implmentiran ODBC standard
- gonilnik, lahko omogoča izvajanje ukazov prek tekstovne datoteke, Excel preglednice ...
