...
- sistemski klici:
	...
	- je način komunikacije z jedrom OS, prek katerega OS nadzira, kateri procesi imajo dostop do posameznih funkcionalnosti OS (kot so branje datotek, ustvarjanje procesov ...)
