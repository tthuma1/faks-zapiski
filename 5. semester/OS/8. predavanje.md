...
- povezovalna pravila:
	...
	- zaupanje (confidence/accuracy) = če uporabim to pravilo, v koliko primerih bom imel prav (ta številka je ponavadi bistveno nižja kot pri CA)
	- več je boljše pri obeh
	- zaupanje je lahko tudi npr. 20% - npr. če imaš letak z izdelki, želiš, da jih uporabnik samo nekaj (malo) zares kupi, ker ne moreš pričakovati, da bo kupil večino
	- podpora je lahko samo npr. 1%, ker 1% pri milijonih uporabnikov je še vedno zelo veliko uporabnikov

- dislike se hočeš včasih izogniti in samo rečeš, da ni dovolj dokazov za like (priporočati želiš samo dobre stvari)

Primer v zvezku:
- nimamo aktivnega uporabnika, ker gledamo povezovalna pravila med katerim
- ko dodamo nov izdelek ne rabimo rušiti vsega, kar smo se do zdaj naučili
- je spet podobno kot many weak learners, ker se lahko naučiš ogromno pravil

- podobno kot pri random forest, lahko narediš hierarhijo povezovalnih pravil (od bolj pomembnih (splošnih) pravil do manj pomembnih (nišnih) - bolj pomembno mora nujno vžgati, da čemurkoli verjamemo, za manj pomembno mogoče ni nujno) ali pa jih samo prešteješ (več pravil kot bo vžgalo, bolj verjamem v like; postavim mejo na X pravil mora vžgati)