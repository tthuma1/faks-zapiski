...
### Napadi na priporočilne sisteme

Push napad:
- svoj item porineš naprej, da si prikazan v marketinške namene

Nuke:
- želiš uničiti dobro ime nekega izdelka

- push in nuke sta omejena samo na en izdelek ali množico izdelkov
- napad na celoten sistem - najtežji, želiš nedelovanje celotnega recommenderja
- push je najlažji, potem nuke in napad na sistem

- hibridne sisteme je težje napasti, ker imajo več komponent
- dodatni (bot) profili; tudi kupuješ profile, ki imajo pozitivno zgodovino, da ni preveč sumljivo
- komu naj bo podoben tvoj bot

- target = izdelek, ki ga hočeš pushati ali nukati
- hočeš dati take ratinge, da boš čim bolj podoben tvoji ciljni skupini
- ne smeš ratati vsega, ker si potem takoj sumljiv, ker noben realno ne oceni vseh izdelkov
- filler ratingi = nekaj oceniš, kar tvoja ciljna publika ni ocenila, da nisi preveč sumljiv

- kako napolniti ratinge:
	- random:
		- podoben boš precej profilom, ampak lahko smo boljši, ker so tu vsa ujemanja po naključju - hočemo se ujeti pravim uporabnikom, da jim lahko podtaknemo lažno oceno
		- bolje - hočeš random okrog globalnega povprečja
	- average:
		- avg za ratings, random za filler
		- postal boš podoben več uporabnikom kot z random
		- ko boš dal napačno oceno, bo ponavadi manj narobe kot z random
		- nekatere spletne strani zato ne dajo povprečne ocene, da preprečijo ta napad
	- bandwagon:
		- oceniš trenutne blockbusterje (trenutno popularne oz. trenutno nepopularne filme)
		- spet si povečaš količino ocen, ki so podobni userju X, ker bodo vsi userji ta film dobro oz. vsi slabo ocenili
		- kontroverzni izdelki - množica pozitivnih in negativnih ocen, brez vmesnih
		- želiš si povečati število skupnih ocen z velikim številom uporabnikom povečati (kot n_A,user pri prejšnjem primeru)
	- segmentni napad:
		- prej smo fake priporočali izdelke vsem
		- tu se osredotočiš samo na neko množico ljudi (npr. osredotoči se samo na ljudi, ki gledajo znanstveno fantastiko)
		- manj sumljivi bomo in bolj nam bo verjel, če se osredotočimo na neko specifično skupino ljudi
		- če fake priporočas vsem, delaš napad na cel sistem
		- npr. ljudem, ki gledajo znanstveno fantastiko bomo pushali naš znanstveno fantastični film
		- ne samo, da je segmentni napad bolj uspešen, ampak je tudi bolj smiselen, ker je tvoje fake priporočilo bolj verjetno upoštevano, ker izgleda real (bolj verjetno je, da bo uporabnik, ki si mu pushal film, potem to res gledal)
	- reverse bandwagon:
		- za nuke
		- poskušaš asociirati slabo oceno nekega filma z dobrimi ocenami blockbusterja

- realen primer:
	- user-user: 3% fake profilov nam zaniha oceno za 1.5 od 5 zvezdic
	- item-item: 15% fake profilov nam zaniha 0.15 od 5 zvezdic - veliko bolj resilient

- lahko reverse engineeramo model:
	- delamo veliko queryjev, ki so čim bolj različni, da vidiš, kako posamezen del queryja vpliva na priporočila
	- ko veš, kako približno nek recommender dela, ga boš lažje napadel; lahko boš napadel tudi content-based recommender
	- nerabiš čisto točno reverse engineerati, ampak good enough

- kako zaznati napad:
	- meriš metrike, npr. koliko je novih uporabnikov
	- če zaznaš, da je nek user bot, ga ne upoštevaš pri priporočilih
	- ratinge novih uporabnikov ne upoštevaš, dokler profil ni star vsaj npr. en mesec
	- če rating in standardna deviacija nekega filma nenadoma skoči gor, gre najbrž za napad