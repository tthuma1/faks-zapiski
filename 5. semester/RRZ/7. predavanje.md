...
- če radij poznamo vnaprej, ga hardcodiramo in si poenostavimo eno dimenzijo:
	...
	- če iščemo prevelik ali prevelik radij, kot je zares, se bodo krožnice v parametričnem polju sekale okrog radije, ker overshootajo/undershootajo
...
- uporabimo posplošeno Houghovo transformacijo (GHT):
	...
	- naredimo r-tabelo:
		- v to tabelo vnašam opisnike teh točk, ko gramo okrog naše oblike
		...
		- dodamo kot $\phi$ med $\beta$ in gradientom => kot od $\phi$ nam v bistvu pove gradient - vemo, da nam ta točka vodi v center predmeta v smeti $\beta$
...
- recimo, da imamo avto:
	...
	- ko na novi sliki zaznamo kolo, je center ali na eni, ali n a drugi strani avtomobila - tam, kjer sta oba glasova, je pravi center
...
- z RANSAC lahko se znabimo šumnih točk, če vemo, da je ena krožnica
...
- če se le da, skušamo zmanjšati število parametrov; želimo čim bolj zmanjpati dimenzijo problema

### Robotika

- rutinsko industrijski roboti (s tem se bomo mi ukvarjali)
- avtonomni roboti
