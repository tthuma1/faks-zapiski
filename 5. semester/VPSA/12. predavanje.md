...
Upravljalnik sporočil:
- FIFO:
	- gleda se vrstni red na posamezni proces (npr. vsi paketi iz procesa A so prišli v pravem vrstnem redu)
	- vsako sporočilo mora imeti ID procesa, zaporedno številko in vsebino
	- upravljalnik sporočil za vsak proces vodi številko naslednjega paketa, ki ga pričakuje - dokler ne dobi tega sporočila, dajaj pakete tega procesa v medpomnilnik, da jih boš potem lahko sortiral
- vzročno razširjanje:
	- vrstni red se se gleda med pošiljatelji
	- če se dve sporočili prenašata sočasnom, nam ne garantira vrstnega reda
	- podobno kot vektorska ura - enako kot FIFO, ampak namesto zaporedne številke rabiš vektor dogodkov
	- pošiljaš ID procesa, vektorsko uro in vsebino
- popolnoma urejeno razširjanje:
	- ko samemu sebi pošiljaš sporočila, moraš pri sočasnih sporočilih počakati, preden pošlješ sporočilo samemu sebi
	- pri raft/verižni replikaciji je to narejeno preko voditelja/nadzornika (imamo eno vstopno točko)
